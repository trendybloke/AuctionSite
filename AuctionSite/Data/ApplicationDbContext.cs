			...
			builder.Entity<AuctionModel>()
				.HasData(new AuctionModel[]
				{
					new AuctionModel
					{
						...
						Category = AuctionCategory.System_Components,
					...
					new AuctionModel
					{
						...
						Category = AuctionCategory.System_Components | AuctionCategory.Faulty_Systems,
						State = AuctionState.Open,
						StartDate = new DateTime(2023, 1, 1),
						EndDate = new DateTime(2024, 1, 1),
						//WatchingUserIDs = new List<string>(),
					...
					new AuctionModel
					{
						...
						Category = AuctionCategory.Complete_Systems,
						State = AuctionState.Open,
						StartDate = new DateTime(2023, 1, 1),
						EndDate = new DateTime(2024, 1, 1),
						//WatchingUserIDs = new List<string>(),
